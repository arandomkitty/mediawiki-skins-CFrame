...
function main() {
	...
	if (state == true) {
		sidebar.setAttribute("class", "vector-legacy-sidebar collapsed");
		...
		sidebar.setAttribute("class", "vector-legacy-sidebar expanded");
	...
	collapse.addEventListener("click", () => {
		...
		if (state == true) {
			...
			.setAttribute("class", "vector-legacy-sidebar collapsed");
		} else if (state == false) {
			document.querySelector("#mw-panel")
			.setAttribute("class", "vector-legacy-sidebar expanded");
		}
	});
