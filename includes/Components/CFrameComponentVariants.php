...
/**
 * CFrameComponentVariants component
 */
class CFrameComponentVariants implements CFrameComponent {
	...
	private function getDropdownData() {
		$dropdown = new CFrameComponentDropdown(
	...
	private function getMenuDropdownData() {
		...
		$menu = new CFrameComponentMenu( $this->menuData );
