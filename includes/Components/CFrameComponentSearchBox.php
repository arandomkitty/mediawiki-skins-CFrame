...
/**
 * CFrameSearchBox component
 */
class CFrameComponentSearchBox implements CFrameComponent {
	...
	/** @var Config */
	private $config;
	private const SEARCH_COLLAPSIBLE_CLASS = 'cframe-search-box-collapses';
	private const SEARCH_SHOW_THUMBNAIL_CLASS = 'cframe-search-box-show-thumbnail';
	private const SEARCH_AUTO_EXPAND_WIDTH_CLASS = 'cframe-search-box-auto-expand-width';
	...
	private function doesSearchHaveThumbnails(): bool {
		return $this->getConfig()->get( 'CFrameWvuiSearchOptions' )['showThumbnail'];
	}
	...
	public function getTemplateData(): array {
		...
		$searchClass = 'cframe-search-box-vue ';
		...
		$searchButton = new CFrameComponentButton(
